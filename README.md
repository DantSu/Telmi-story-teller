![Total Download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/total.svg) [![v1.5.1 download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/1.5.1/total.svg)](https://github.com/DantSu/Telmi-story-teller/releases/tag/1.5.1)
...
- [Download the latest version of Telmi](https://github.com/DantSu/Telmi-story-teller/releases/download/1.5.1/TelmiOS_v1.5.1.zip)
...
### Unzip TelmiOS_v1.5.1.zip

Put the content of `TelmiOS_v1.5.1.zip` at the root of the SD card.

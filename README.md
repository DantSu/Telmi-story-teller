![Total Download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/total.svg) [![v1.4.4 download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/1.4.4/total.svg)](https://github.com/DantSu/Telmi-story-teller/releases/tag/1.4.4)
...
- [Download the latest version of Telmi](https://github.com/DantSu/Telmi-story-teller/releases/download/1.4.4/TelmiOS_v1.4.4.zip)
...
### Unzip TelmiOS_v1.4.4.zip

Put the content of `TelmiOS_v1.4.4.zip` at the root of the SD card.

![Total Download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/total.svg) [![v1.7.3 download](https://img.shields.io/github/downloads/DantSu/Telmi-story-teller/1.7.3/total.svg)](https://github.com/DantSu/Telmi-story-teller/releases/tag/1.7.3)
...
- [Download the latest version of Telmi](https://github.com/DantSu/Telmi-story-teller/releases/download/1.7.3/TelmiOS_v1.7.3.zip)
...
### Unzip TelmiOS_v1.7.3.zip

Put the content of `TelmiOS_v1.7.3.zip` at the root of the SD card.

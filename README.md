...
- [Download the latest version of Telmi](https://github.com/DantSu/Telmi-story-teller/releases/download/1.9.0/TelmiOS_v1.9.0.zip)
...
### Unzip TelmiOS_v1.9.0.zip

Put the content of `TelmiOS_v1.9.0.zip` at the root of the SD card.
